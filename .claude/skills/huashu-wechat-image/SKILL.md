...
如果需求包含正文配图，先 Read `references/article-image-planning.md`，为每张图定义任务和生成路径；不要按 H2 机械插图。
...
| **B. 正文配图** | 章节配图，辅助阅读理解 | 2-5张 | 先规划，再按图型选 AI / HTML / SVG |
| **C. 全套配图** | 封面 + 正文全部 | 3-6张 | 封面 AI，正文混合路径 |
| **D. 纯信息图** | 数据对比、流程图、清单 | 1-5张 | HTML / SVG 为主，少量概念图可 AI |
...
> 有视觉创意需求的封面、概念图、氛围图优先 AI。
> 需要文字准确、步骤清楚、数据可信的流程图、清单图、表格图优先 HTML / SVG。
> 不要为了省事把精确文字交给 AI，也不要把概念氛围图做成平面 PPT。
...
| 头条封面 | **AI** | 视觉冲击力强，质感好 |
| 正文氛围/场景图 | **AI** | 创意性强 |
| 正文信息图 | **HTML / SVG** | 文字、数字、层级必须准确 |
| 流程图/步骤图 | **HTML / SVG** | 可读性和可复渲染优先 |
| 对比图 | **HTML / SVG** | 信息结构比氛围更重要 |
| 精确数据表格（10+单元格） | **HTML** | 唯一需要HTML的场景：大量精确数字 |

**正文配图默认先按 `references/article-image-planning.md` 判断图型，再选择路径。**
...
- `references/article-image-planning.md` — 正文配图任务、图型、AI/HTML/SVG 路径选择
